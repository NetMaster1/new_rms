...
urlpatterns = [
   ...
   #=========================================================================
    ...
    path ('check_inventory_unposted/<int:identifier_id>', views.check_inventory_unposted, name='check_inventory_unposted'),
    path ('check_inventory/<int:document_id>', views.check_inventory, name='check_inventory'),

    path ('enter_new_product_inventory_unposted/<int:identifier_id>', views.enter_new_product_inventory_unposted, name='enter_new_product_inventory_unposted'),
